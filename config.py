...
OWNER_ID     = list(map(int, os.getenv("OWNER_ID", "7707859083").split()))  # space-separated list
STRING       = os.getenv("STRING", None)  # optional session string
LOG_GROUP    = int(os.getenv("LOG_GROUP", "-1003577647826"))
FORCE_SUB    = int(os.getenv("FORCE_SUB", "-1003228677818"))
...
# ─── UI / LINKS ─────────────────────────────────────────────────────────────────
JOIN_LINK     = os.getenv("JOIN_LINK", "https://t.me/MAGICxBots")
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/ig_magic")
